...
<p>The <strong>sessionStorage</strong> adapter provides temporary storage that lasts only for the current browser session. Data is cleared when the tab or browser is closed.</p><h2 id="overview">Overview</h2>
