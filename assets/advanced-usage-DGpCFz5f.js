...
<p>Learn how to handle complex data types, optimize performance, and follow best practices.</p><h2 id="custom-serialization">Custom Serialization</h2>
<p>By default, <code>ngx-persist</code> uses <code>JSON.stringify</code> and <code>JSON.parse</code>. If you need to store types that JSON doesn&#39;t support natively (like <code>Date</code>, <code>Map</code>, or <code>Set</code>), you can provide custom serializers.</p><h3 id="example-storing-dates">Example: Storing Dates</h3>
...
</code></pre><h3 id="example-storing-maps">Example: Storing Maps</h3>
...
<span class="token punctuation">}</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
</code></pre><h2 id="async-handling">Async Handling</h2>
<p>When using asynchronous adapters (like IndexedDB or API), the signal might not have the stored value immediately upon creation.</p><h3 id="the-loaded-signal">The <code>loaded</code> Signal</h3>
...
<p>For offline-first data fetching, you can use <code>persistResource</code> to wrap an Angular <code>ResourceLoader</code>.</p><p><a href="/usage/resource-api"><strong>Read the full guide on Resource API</strong></a></p><h2 id="best-practices-1">Best Practices</h2>
...
<h3 id="3-server-side-rendering-ssr">3. Server-Side Rendering (SSR)</h3>
